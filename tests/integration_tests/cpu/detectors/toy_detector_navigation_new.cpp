...
int main(int argc, char **argv) {
    ...
    cfg_ray_scan.name("toy_detector_ray_scan").write_intersections(true);
    ...
    cfg_hel_scan.name("toy_detector_helix_scan").write_intersections(true);
