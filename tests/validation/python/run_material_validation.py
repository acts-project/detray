...
#------------------------------------------------------------------------run
    ...
    plot_material_scan.X0_vs_eta_phi(df, "toy detector", plot_factory, 500, 500)
    plot_material_scan.L0_vs_eta_phi(df, "toy detector", plot_factory, 500, 500)
    plot_material_scan.X0_vs_eta(df, "toy detector", plot_factory, 500)
    plot_material_scan.L0_vs_eta(df, "toy detector", plot_factory, 500)
