...
inline auto run_propagation_device(
    ...
    const vecmem::jagged_vector<vector3_t> &host_positions) -> std::tuple<vecmem::jagged_vector<scalar>, vecmem::jagged_vector<vector3_t>, vecmem::jagged_vector<free_matrix>> {
