...
GTEST_TEST(detray_tools, decorator_homogeneous_material_builder) {
    ...
    auto mat_builder = homogeneous_material_builder<detector_t>{std::move(vbuilder)};
...
GTEST_TEST(detray_tools, detector_builder_with_material) {
    ...
    auto mat_sf_factory =
        std::make_shared<homogeneous_material_factory<detector_t>>(std::move(trpz_factory));
    ...
    auto mat_portal_factory = std::make_shared<homogeneous_material_factory<detector_t>>(
