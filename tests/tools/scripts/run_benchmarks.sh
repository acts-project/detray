...
do
    ...
    do
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_"$algebra" \
            ...
            --benchmark_out=toy_detector_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_pT"$pT"GeV.json
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_"$algebra" \
            ...
            --benchmark_display_aggregates_only=true       \
            --benchmark_out_format=json                    \
            --benchmark_out=toy_detector_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_grids_pT"$pT"GeV.json
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_"$algebra" \
            ...
            --benchmark_display_aggregates_only=true       \
            --benchmark_out_format=json                    \
            --benchmark_out=toy_detector_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_cov_pT"$pT"GeV.json
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_"$algebra" \
            ...
            --benchmark_display_aggregates_only=true       \
            --benchmark_out_format=json                    \
            --benchmark_out=toy_detector_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_cov_grids_pT"$pT"GeV.json
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_$algebra \
            ...
            --benchmark_display_aggregates_only=true       \
            --benchmark_out_format=json                    \
            --benchmark_out=odd_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_pT"$pT"GeV.json
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_$algebra \
            ...
            --benchmark_display_aggregates_only=true       \
            --benchmark_out_format=json                    \
            --benchmark_out=odd_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_grids_pT"$pT"GeV.json
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_$algebra \
            ...
            --benchmark_display_aggregates_only=true       \
            --benchmark_out_format=json                    \
            --benchmark_out=odd_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_cov_pT"$pT"GeV.json
        ...
        $bin_dir/detray_propagation_"$bench"_"$backend"_$algebra \
            ...
            --benchmark_display_aggregates_only=true       \
            --benchmark_out_format=json                    \
            --benchmark_out=odd_"$bench"_"$backend"_"$hw_backend_file"_"$algebra"_cov_grids_pT"$pT"GeV.json
