...
def plot_track_params(opts, detector, track_type, plot_factory, out_format,
                      df):
    ...
    q_hist_data = plot_factory.hist1D(x       = df['q'],
                                     bins    = 4,
    ...
    plot_factory.write_plot(q_hist_data,
    ...
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    p_hist_data = plot_factory.hist1D(x       = p,
                                     bins    = 100,
    ...
    plot_factory.write_plot(p_hist_data,
    ...
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    pT_hist_data = plot_factory.hist1D(x      = pT,
                                      bins    = 100,
    ...
    plot_factory.write_plot(pT_hist_data,
                           f"{detector_name}_{track_type}_pT_dist",
                           out_format)

    # Plot the x-origin
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    x_hist_data = plot_factory.hist1D(x      = df['x'],
                                     bins    = 100,
    ...
    plot_factory.write_plot(x_hist_data,
                           f"{detector_name}_{track_type}_x_origin",
                           out_format)

    # Plot the y-origin
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    y_hist_data = plot_factory.hist1D(x      = df['y'],
                                     bins    = 100,
    ...
    plot_factory.write_plot(y_hist_data,
                           f"{detector_name}_{track_type}_y_origin",
                           out_format)
    # Plot the z-origin
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    z_hist_data = plot_factory.hist1D(x      = df['z'],
                                     bins    = 100,
    ...
    plot_factory.write_plot(z_hist_data,
    ...
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    dir_phi_hist_data = plot_factory.hist1D(x      = phi,
                                        bins    = 100,
    ...
    plot_factory.write_plot(dir_phi_hist_data,
    ...
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    dir_theta_hist_data = plot_factory.hist1D(x      = theta,
                                             bins    = 100,
    ...
    plot_factory.write_plot(dir_theta_hist_data,
    ...
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    dir_eta_hist_data = plot_factory.hist1D(x       = eta,
                                           bins    = 100,
                                           x_label  = r'$\eta$',
                                           lgd_ops = lgd_ops,
                                           figsize  = (8.5, 8.5),
    ...
    plot_factory.write_plot(dir_eta_hist_data,
                           f"{detector_name}_{track_type}_dir_eta",
                           out_format)


""" Plot the track positions of two data sources - rz view """
def compare_track_pos_xy(opts, detector, scan_type, plot_factory, out_format,
...
""" Plot the track positions of two data sources - rz view """
def compare_track_pos_rz(opts, detector, scan_type, plot_factory, out_format,
                         df1, label1, color1, df2, label2, color2):
    ...
    # Compare agaist second data set
    plot_factory.highlight_region(hist_data, second_z, np.hypot(second_x, second_y), color2, label2)
...
def plot_track_pos_dist(opts, detector, scan_type, plot_factory, out_format,
    ...
    # Plot the xy coordinates of the filtered intersections points
    lgd_ops = plotting.legend_options(lgd_loc, 4, 0.8, 0.005)
    hist_data = plot_factory.hist1D(x       = filtered_dist,
                                   bins    = 100,
    ...
    l1 = label1.replace(' ', '_').replace("(", "").replace(")", "")
    l2 = label2.replace(' ', '_').replace("(", "").replace(")", "")
    plot_factory.write_plot(hist_data,
                           f"{detector_name}_{scan_type}_dist_{l1}_{l2}",
                           out_format)


""" Plot the track position residual for the given variable """
def plot_track_pos_res(opts, detector, scan_type, plot_factory, out_format,
    ...
    hist_data = plot_factory.hist1D(x        = filtered_res,
                                   figsize  = (9, 9),
                                   bins     = 100,
