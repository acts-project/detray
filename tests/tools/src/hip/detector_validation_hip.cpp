...
#include "detray/test/device/hip/navigation_validation.hpp"
...
int main(int argc, char** argv) {
    ...
    po::options_description desc("\ndetray detector HIP validation options");
    ...
    detray::hip::straight_line_navigation<detector_t>::config str_nav_cfg{};
    detray::hip::helix_navigation<detector_t>::config hel_nav_cfg{};
    ...
    ray_scan_cfg.name(det_name + "_ray_scan_for_hip");
    ...
    hel_scan_cfg.name(det_name + "_helix_scan_for_hip");
    ...
    str_nav_cfg.name(det_name + "_straight_line_navigation_hip");
    ...
    detray::test::register_checks<detray::hip::straight_line_navigation>(
    ...
    hel_nav_cfg.name(det_name + "_helix_navigation_hip");
    ...
    detray::test::register_checks<detray::hip::helix_navigation>(
