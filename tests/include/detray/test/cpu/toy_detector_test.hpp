...
struct volume_link_getter {
    ...
    template <typename mask_group_t, concepts::interval mask_range_t>
    inline auto operator()(const mask_group_t& mask_group,
                           const mask_range_t& mask_range) {
        dvector<std::size_t> vol_links{};
        for (const auto& mask :
             detray::ranges::subrange(mask_group, mask_range)) {
            vol_links.push_back(static_cast<std::size_t>(mask.volume_link()));
        }
        return vol_links;
    }
};
...
inline bool toy_detector_test(
    ...
    check_sf_ranges(*vol_itr, {1770u, 1774u}, {1042u, 1772u}, {});
    ...
    index = {12u};
    accel_link = {accel_ids::e_brute_force, 0u};
    check_sf_ranges(*vol_itr, {1772u, 1776u}, {}, {});
    ...
    test_portal_links(vol_itr->index(),
                      surfaces.begin() + static_cast<std::ptrdiff_t>(range[0]),
                      range, range[0],
                      {mask_ids::e_portal_cylinder2, {36u, 1u}},
                      {material_ids::e_none, inv_link}, portal_mat, {{9u},
    {11u}});
    // disc portals
    range = {1774u, 1776u};
    test_portal_links(vol_itr->index(),
                      ...
                      {material_ids::e_none, inv_link}, portal_mat, {{2u},
    {17u}});

    // Check link of surfaces in surface finder
    test_accel(vol_itr, accel, {1772u, 1776u});
    ...
    check_sf_ranges(*vol_itr, {2868u, 2872u}, {1776u, 2868u}, {});
    ...
    test_portal_links(vol_itr->index(),
                      surfaces.begin() + static_cast<std::ptrdiff_t>(range[0]),
                      range, range[0],
                      {mask_ids::e_portal_cylinder2, {38u, 1u}},
                      {material_ids::e_none, inv_link}, portal_mat, {{14u},
    {15u}});
    ...
    // Check link of surfaces in surface finder
    test_accel(vol_itr, accel, {2868u, 2872u}, {1776u, 2868u});
    ...
    index = {14u};
    accel_link = {accel_ids::e_brute_force, 0u};
    check_sf_ranges(*vol_itr, {2872u, 2876u}, {}, {});
    ...
    test_portal_links(vol_itr->index(),
                      surfaces.begin() + static_cast<std::ptrdiff_t>(range[0]),
                      range, range[0],
                      {mask_ids::e_portal_cylinder2, {40u, 1u}},
                      {material_ids::e_none, inv_link}, portal_mat, {{11u},
    {13u}});
    // disc portals
    range = {2874u, 2876u};
    test_portal_links(vol_itr->index(),
    ...
    // Check link of surfaces in surface finder
    test_accel(vol_itr, accel, {2872u, 2876u});
    ...
    index = {15u};
    accel_link = {accel_ids::e_brute_force, 0u};
    check_sf_ranges(*vol_itr, {2876u, 2880u}, {}, {});
    ...
    // Check link of surfaces in surface finder
    test_accel(vol_itr, accel, {2876u, 2880u});
    ...
    index = {16u};
    accel_link = {accel_ids::e_disc_grid, 0u};
    check_sf_ranges(*vol_itr, {2988u, 2992u}, {2880u, 2988u}, {});
    ...
    test_portal_links(vol_itr->index(),
                      ...
                      {material_ids::e_none, inv_link}, portal_mat, {{17u},
    {19u}});

    // Check link of surfaces in surface finder
    test_accel(vol_itr, accel, {2988u, 2992u}, {2880u, 2988u});
    ...
    index = {17u};
    accel_link = {accel_ids::e_brute_force, 0u};
    check_sf_ranges(*vol_itr, {2992u, 2996u}, {}, {});
    ...
    test_portal_links(vol_itr->index(),
                    surfaces.begin() + static_cast<std::ptrdiff_t>(range[0]),
                    range, range[0], {mask_ids::e_portal_ring2, {43u, 1u}},
                    {material_ids::e_none, inv_link}, portal_mat,
                    {{16u}});
    // cylinder portals
    range = {2994u, 2996u};
    ...
    // Check link of surfaces in surface finder
    test_accel(vol_itr, accel, {2992u, 2996u});
    ...
    check_sf_ranges(*vol_itr, {3104u, 3118u}, {2996u, 3104u}, {});
    ...
    test_portal_links(vol_itr->index(),
                      ...
                      {material_ids::e_none, inv_link}, portal_mat, {{19u},
    {21u}});

    // Check link of surfaces in surface finder
    test_accel(vol_itr, accel, {3104u, 3118u}, {2996u, 3104u});
