...
TEST(ALGEBRA_PLUGIN, index_geometry) {
    ...
    /// volume 1
    /// volume portals
    auto pt3 = portal(0, {geometry::e_portal_cylinder3, {0, 0}}, 1, 6);
    auto pt4 = portal(0, {geometry::e_portal_cylinder3, {1, 1}}, 1, 6);
    auto pt5 = portal(1, {geometry::e_portal_ring2, {0, 0}}, 1, 7);
    auto pt6 = portal(1, {geometry::e_portal_ring2, {1, 1}}, 1, 7);
    /// Surface 2
    ...
    ASSERT_EQ(std::get<1>(pt3.mask())[1], 1);
    ASSERT_EQ(std::get<1>(pt4.mask())[0], 2);
    ASSERT_EQ(std::get<1>(pt4.mask())[1], 2);
    ASSERT_EQ(std::get<1>(pt5.mask())[0], 2);
    ASSERT_EQ(std::get<1>(pt5.mask())[1], 2);
    ASSERT_EQ(std::get<1>(pt6.mask())[0], 3);
    ASSERT_EQ(std::get<1>(pt6.mask())[1], 3);
    ...
    ASSERT_EQ(g.template n_objects<geometry::e_portal>(), 7);
    ...
    objects_range = darray<dindex, 2>{3, 7};
