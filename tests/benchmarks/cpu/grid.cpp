...
auto make_regular_grid(vecmem::memory_resource &mr) {
    ...
    return gr_factory.template new_grid<rectangle2D<>>(
        spans, nbins, {},
        types::list<n_axis::closed<n_axis::label::e_x>,
                    n_axis::closed<n_axis::label::e_y>>{},
        types::list<n_axis::regular<>, n_axis::regular<>>{});
}
...
auto make_irregular_grid(vecmem::memory_resource &mr) {
    ...
    return gr_factory.template new_grid<rectangle2D<>>(
        ...
        types::list<n_axis::closed<n_axis::label::e_x>,
                    n_axis::closed<n_axis::label::e_y>>{},
        types::list<n_axis::irregular<>, n_axis::irregular<>>{});
}
