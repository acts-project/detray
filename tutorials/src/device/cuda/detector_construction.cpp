...
int main() {
    ...
    auto det_fixed_buff = detray::get_buffer<covfie::field<detray::const_bfield_bknd_t>>(det_host, dev_mr, cuda_cpy);
    ...
    auto det_resz_buff =
        detray::get_buffer<covfie::field<detray::const_bfield_bknd_t>>(det_host, dev_mr, cuda_cpy, detray::copy::sync,
    ...
    auto det_custom_buff = detray::detector_buffer<covfie::field<detray::const_bfield_bknd_t>, detray::tutorial::detector_host_t>(
