...
class square_surface_generator final
    : public surface_factory_interface<detector<tutorial::my_metadata, covfie::field<const_bfield_bknd_t>>> {

    public:
    using detector_t = detector<tutorial::my_metadata, covfie::field<const_bfield_bknd_t>>;
