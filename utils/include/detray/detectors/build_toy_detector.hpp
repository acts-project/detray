...
struct toy_det_config {
    ...
    toy_det_config() {
        ...
        m_beampipe_map_cfg.thickness = 0.08f * unit<scalar_t>::mm;
        ...
        m_disc_map_cfg.thickness = 0.15f * unit<scalar_t>::mm;
        m_disc_map_cfg.scalor = 0.0000001f;
        ...
        m_cyl_map_cfg.mapped_material =
            mixture<scalar_t, silicon_tml<scalar_t, std::ratio<9, 10>>,
                    aluminium<scalar_t, std::ratio<1, 10>>>{};
        m_cyl_map_cfg.thickness = 0.15f * unit<scalar_t>::mm;
