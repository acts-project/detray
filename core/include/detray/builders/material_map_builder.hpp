...
class material_map_builder final : public volume_decorator<detector_t> {
    ...
    explicit material_map_builder(
        ...
        DETRAY_DEBUG_HOST(
            "Material map builder created for volume: " << this->name());
    }
    ...
    void add_surfaces(
        ...
        DETRAY_DEBUG_HOST("material_map_builder::add_surfaces()");
    ...
    auto build(detector_t& det,
        ...
        DETRAY_DEBUG_HOST("material_map_builder::build()");
        ...
        DETRAY_DEBUG_HOST("material_map_builder defers to contained builders");
        // Construct the surfaces
        typename detector_t::volume_type* vol_ptr =
            volume_decorator<detector_t>::build(det, ctx);
        DETRAY_DEBUG_HOST("material_map_builder back in build");
        ...
        DETRAY_VERBOSE_HOST(
            "Successfully added material maps to volume: " << this->name());
    ...
    void update_material_links(const detector_t& det) {
        DETRAY_DEBUG_HOST("material_map_builder::update_material_links()");
