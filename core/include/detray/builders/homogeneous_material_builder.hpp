...
class homogeneous_material_builder final : public volume_decorator<detector_t> {
    ...
    explicit homogeneous_material_builder(
        ...
        DETRAY_DEBUG_HOST("Homogeneous material builder created for volume: "
                          << this->name());
    }
    ...
    void add_surfaces(
        ...
        DETRAY_DEBUG_HOST("homogeneous_material_builder::add_surface()");
        ...
        auto mat_factory =
            std::dynamic_pointer_cast<homogeneous_material_factory<detector_t>>(
                sf_factory);
        if (mat_factory) {
            DETRAY_DEBUG_HOST("-> found material factory: calling");
        ...
        if (mat_generator) {
            DETRAY_DEBUG_HOST("-> found material generator: calling");
    ...
    auto build(detector_t &det,
        ...
        DETRAY_DEBUG_HOST("homogeneous_material_builder::build()");
        ...
        DETRAY_VERBOSE_HOST(
            "Successfully added homogeneous material to volume: "
            << this->name());
