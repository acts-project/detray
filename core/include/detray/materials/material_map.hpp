...
struct is_material_map<
    material_t,
    std::enable_if_t<
        is_grid<material_t>::value  &&
            std::is_same<
                typename material_t::value_type,
                material_slab<typename material_t::value_type::scalar_type>>::value ,
...
struct is_surface_material<
    material_t,
    std::enable_if_t<is_material_map<material_t>::value  && (material_t::dim == 2),
                     void>> : public std::true_type {};
...
struct is_volume_material<
    material_t,
    std::enable_if_t<is_material_map<material_t>::value  && (material_t::dim == 3),
                     void>> : public std::true_type {};
