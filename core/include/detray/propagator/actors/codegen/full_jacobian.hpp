              ...
              algebra::traits::rank<full_jacobian_t> == 6))
{
    ...
    getter::element<4, 0>(full_jacobian) = 0;
    getter::element<5, 0>(full_jacobian) =
        getter::element<0, 0>(b2f_dpos_dloc) *
            getter::element<3, 0>(transport_jacobian) +
        getter::element<1, 0>(b2f_dpos_dloc) *
            getter::element<3, 1>(transport_jacobian) +
        getter::element<2, 0>(b2f_dpos_dloc) *
            getter::element<3, 2>(transport_jacobian);
    ...
    getter::element<4, 1>(full_jacobian) = 0;
    getter::element<5, 1>(full_jacobian) =
        getter::element<0, 1>(b2f_dpos_dloc) *
            getter::element<3, 0>(transport_jacobian) +
        getter::element<1, 1>(b2f_dpos_dloc) *
            getter::element<3, 1>(transport_jacobian) +
        getter::element<2, 1>(b2f_dpos_dloc) *
            getter::element<3, 2>(transport_jacobian);
    ...
    getter::element<4, 2>(full_jacobian) = 0;
    getter::element<5, 2>(full_jacobian) =
        getter::element<0, 0>(b2f_ddir_dangle) *
            getter::element<3, 4>(transport_jacobian) +
        getter::element<1, 0>(b2f_ddir_dangle) *
            getter::element<3, 5>(transport_jacobian) +
        getter::element<0, 0>(b2f_dpos_dangle) *
            getter::element<3, 0>(transport_jacobian) +
        getter::element<1, 0>(b2f_dpos_dangle) *
            getter::element<3, 1>(transport_jacobian) +
        getter::element<2, 0>(b2f_dpos_dangle) *
            getter::element<3, 2>(transport_jacobian);
    ...
    getter::element<3, 3>(full_jacobian) =
        ...
        (x49 * getter::element<0, 6>(transport_jacobian) +
         ...
         x54 * getter::element<6, 6>(transport_jacobian)) *
            getter::element<2, 1>(b2f_ddir_dangle);
    getter::element<4, 3>(full_jacobian) = 0;
    getter::element<5, 3>(full_jacobian) =
        getter::element<0, 1>(b2f_ddir_dangle) *
            getter::element<3, 4>(transport_jacobian) +
        getter::element<1, 1>(b2f_ddir_dangle) *
            getter::element<3, 5>(transport_jacobian) +
        getter::element<2, 1>(b2f_ddir_dangle) *
            getter::element<3, 6>(transport_jacobian) +
        getter::element<0, 1>(b2f_dpos_dangle) *
            getter::element<3, 0>(transport_jacobian) +
        getter::element<1, 1>(b2f_dpos_dangle) *
            getter::element<3, 1>(transport_jacobian) +
        getter::element<2, 1>(b2f_dpos_dangle) *
            getter::element<3, 2>(transport_jacobian);
    ...
    getter::element<4, 4>(full_jacobian) = 1;
    getter::element<5, 4>(full_jacobian) =
        getter::element<3, 7>(transport_jacobian);
