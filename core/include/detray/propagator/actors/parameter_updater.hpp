...
struct parameter_updater_state {
    ...
    /// observing actors decide if the paramters should be updated.
    DETRAY_HOST_DEVICE
...
struct parameter_transporter : base_actor {
    ...
    DETRAY_HOST_DEVICE result
    operator()(state& updater_state, propagator_state_t& propagation) const {
        ...
        if (!departure_params.surface_link().is_invalid()) {
            ...
            DETRAY_DEBUG_HOST("Actor: Departure surface: "
            ...
            departure_params.set_covariance(
    ...
    DETRAY_HOST_DEVICE void operator()(
        ...
        if (const noise_cfg& cfg = updater_state.noise_estimation_cfg();
            ...
            detail::estimate_external_mask_tolerance(
                ...
                static_cast<dscalar<algebra_t>>(cfg.n_stddev),
