...
struct jacobian_engine {
    ...
    bound_to_free_jacobian(
        ...
        const bound_to_free_jacobian_submatrix_type dpos_dangle =
            bound_to_free_jacobian_submatrix_dpos_dangle<frame_t>(
                trf3, pos, dir, ddir_dangle);
    ...
    bound_to_free_jacobian_submatrix_ddir_dangle(
        ...
        bound_to_free_jacobian_submatrix_type
            bound_angle_to_free_dir_derivative =
        ...
        getter::element(bound_angle_to_free_dir_derivative,
                        e_submatrix_free_dir0, e_submatrix_bound_phi) =
            -sin_theta * sin_phi;
        getter::element(bound_angle_to_free_dir_derivative,
                        e_submatrix_free_dir0, e_submatrix_bound_theta) =
            cos_theta * cos_phi;
        getter::element(bound_angle_to_free_dir_derivative,
                        e_submatrix_free_dir1, e_submatrix_bound_phi) =
            sin_theta * cos_phi;
        getter::element(bound_angle_to_free_dir_derivative,
                        e_submatrix_free_dir1, e_submatrix_bound_theta) =
            cos_theta * sin_phi;
        getter::element(bound_angle_to_free_dir_derivative,
                        e_submatrix_free_dir2, e_submatrix_bound_theta) =
            -sin_theta;
    ...
    bound_to_free_jacobian_submatrix_dpos_dangle(
        ...
        // Get d(x,y,z)/d(loc0, loc1)
        return jacobian_t::get_derivative_dpos_dangle(trf3, pos, dir,
                                                      ddir_dangle);
    }
    ...
    free_to_bound_jacobian_submatrix_dangle_ddir(const vector3_type& dir) {
        ...
        getter::element(dangle_ddir, e_submatrix_bound_phi,
                        e_submatrix_free_dir0) = -sin_phi / sin_theta;
        getter::element(dangle_ddir, e_submatrix_bound_phi,
                        e_submatrix_free_dir1) = cos_phi / sin_theta;
