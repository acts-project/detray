...
dvector<point3>
vertices(const cylinder3<kRadialCheck, intersector_type, local_type, links_type,
...
template <typename intersector_type, typename local_type, typename links_type,
          unsigned int kMaskContext>
dvector<point3>
vertices(const rectangle2<intersector_type, local_type, links_type,
...
template <typename intersector_type, typename local_type, typename links_type,
          unsigned int kMaskContext>
dvector<point3>
vertices(const trapezoid2<intersector_type, local_type, links_type,
